...
node_rank=0
# data
timit_data=/nfs-speech-cfs/BACKUP/asr/en/timit/TIMIT
...
if [ ${stage} -le 0 ] && [ ${stop_stage} -ge 0 ]; then
    ...
    for x in train dev test; do
      mv data/${x}/text data/${x}/text_bk
      tools/rm_sil.py data/${x}/text_bk > data/${x}/text
    done
    echo "Finish stage 0"
fi
...
if [ ${stage} -le 2 ] && [ ${stop_stage} -ge 2 ]; then
    ...
    tools/text2token.py -s 1 -n 1 --trans_type ${trans_type} data/${train_set}/text  \
